...
pvr::Result HelloPVR::initView()
{
    ...
    _uiRenderer.init(width, height, isFullScreen(), (_context->getApiVersion() == pvr::Api::OpenGLES2) || (getBackBufferColorspace() == pvr::ColorSpace::sRGB));
    _uiRenderer.getDefaultTitle()->setText("OpenGLES Framebuffer");
    ...
    _screenp = pvr::utils::createShaderProgram(*this, "Screen.vsh", "Screen.fsh",
    ...
    gl::FramebufferTexture2D(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D, _tb, 0);
